# Vue3 Tailwind Tiptap 2 Editor 🚀

**Vue3 Tailwind Tiptap 2 Editor** – A professional, **high-performance WYSIWYG editor** built with **headless Tiptap v2** and **Tailwind 4**. It combines a premium glassmorphic UI with advanced features typically found in high-end editors like Notion or Google Docs.
...
import { fab } from "@fortawesome/free-brands-svg-icons"; // For YouTube Icon
